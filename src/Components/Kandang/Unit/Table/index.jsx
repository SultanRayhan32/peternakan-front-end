    ...
    <React.Fragment>
      <TableRow className={classes.root}>
        ...
        <TableCell align="right">
          <button onClick={e=>history.push(`/${idUnit}/baris/${row.id_unit}`)} className="detail-button">
            Detail
          </button>
        </TableCell>
        <TableCell align="right">
      ...
      <Table aria-label="collapsible table">
        ...
        <TableBody>
          {props.dataUnit.map((row , index) => (
            <Row idUnit={props.idUnit} key={row.name} row={row} index={index} history={history} />
          ))}
        </TableBody>
      </Table>
    </TableContainer>
